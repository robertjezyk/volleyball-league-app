/*
  ...
  - Added the required column `leagueType` to the `Match` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Match" ("awayTeamId", "createdAt", "date", "homeTeamId", "id", "leaguePointsAway", "leaguePointsHome", "pointsAway", "pointsHome", "setsAway", "setsHome", "updatedAt") SELECT "awayTeamId", "createdAt", "date", "homeTeamId", "id", "leaguePointsAway", "leaguePointsHome", "pointsAway", "pointsHome", "setsAway", "setsHome", "updatedAt" FROM "Match";
DROP TABLE "Match";
